...
import { useCreateUpcomingEvent } from "@/hooks/firebase/upcoming-event.hook";
...
import { useCreateVerseForToday } from "@/hooks/firebase/verse-for-today.hook";
...
const Index = () => {
  const { mutate, isLoading } = useCreateVerseForToday();
  ...
  return (
    <Wrapper>
      <PageHeader>
        <h2 className="header">New Daily Verse</h2>
