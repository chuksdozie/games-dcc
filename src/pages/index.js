...
import MonthFilter, { months } from "@/components/popups/MonthFilter";
...
export default function Home() {
  ...
  const result = useSortMatchTable(month);
  ...
  return (
    ...
    >
      <MonthFilter data={scorelines} month={month} setMonth={setMonth} />
      <p
        style={{
          marginTop: "1rem",
